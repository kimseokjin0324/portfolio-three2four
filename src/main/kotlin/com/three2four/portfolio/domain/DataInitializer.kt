package com.three2four.portfolio.domain

import com.three2four.portfolio.domain.constrant.SkillType
import com.three2four.portfolio.domain.entity.*
import com.three2four.portfolio.domain.repository.*
...
class DataInitializer(
    ...
    @PostConstruct
    fun initializeData() {
        println("스프링이 실행 되었습니다. 테스트 데이터를 초기화 합니다.")
        ...
        val account= Account(
                loginId="three2four",
                pw="\$2a\$10\$lQha88nemWrxMZ8H1SyYVOCvr3VQbE2.gVgvuF.x/L3q.jwnly7cO"
        )
