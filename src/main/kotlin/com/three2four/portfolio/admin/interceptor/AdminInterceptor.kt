        ...
        val menus = listOf<MenuDTO>(
                MenuDTO(
                        ...
                        pages = listOf<PageDTO>(
                                PageDTO(
                                        name = "Introduction", url = "/admin/introduction"
                                ),
                                PageDTO(
                                        name = "Link", url = "/admin/link"
                                )
                        )
                ),
                MenuDTO(
                        ...
                        pages = listOf<PageDTO>(
                                ...
                                PageDTO(
                                        name = "Achievement", url = "/admin/achievement"
                                ),
                                PageDTO(
                                        name = "Skill", url = "/admin/skill"
                                )
                        )
                ),
                MenuDTO(
                        ...
                        pages = listOf<PageDTO>(
                                PageDTO(
                                        name = "Project", url = "/admin/project"
                                ),
                                PageDTO(
                                        name = "ProjectSkill", url = "/admin/project/skill"
                                )
                        )
                )
        )
